...
![Profile Views](https://komarev.com/ghpvc/?username=suryaraj05&color=00ff88&style=flat-square&label=Profile+Views)
&nbsp;&nbsp;
[![LinkedIn](https://img.shields.io/badge/LinkedIn-salve--surya--raj-0077B5?style=flat-square&logo=linkedin)](https://linkedin.com/in/salve-surya-raj)
&nbsp;&nbsp;
...
### 🤖 [TaxSetu](https://github.com/suryaraj05/taxsetu)
**5-Agent GST Compliance Platform**

```
Master Planner
├── Watcher     → OCR invoice ingestion
├── Calculator  → GST + ITC reconciliation
├── Filer       → Pre-flight validation
├── Guardian    → Risk scoring
└── Narrator    → Hindi voice explanations
```

Each agent emits structured JSON:
`decision` `reasoning` `confidence` `notify-flags`

`Gemini API` `React 18` `Firebase` `Multi-Agent`
...
```
Brief → Script → Previz → Risk Analysis
  ↓        ↓        ↓          ↓
Agent   Agent   Gemini     Feasibility
Chain   Chain   Vision      Scorer
```

**🏅 6th Place — CineAI Hackathon, T-Works Hyderabad**
...
| **ParcelHorse.com** | 🇬🇧 UK | International logistics + real-time tracking |
...
ml          = ["TensorFlow", "BiLSTM", "Stability AI SDXL", "Gemini Vision"]
```
...
🥈  6th Place — CineAI Hackathon · T-Works Hyderabad        [Jan 2026]
🎯  Participant — Build For India · KSUM Kerala              [Feb 2026]
...
<img height="160" src="https://github-readme-stats.vercel.app/api?username=suryaraj05&show_icons=true&theme=chartreuse-dark&hide_border=true&bg_color=0a0a0a&title_color=00ff88&icon_color=00ff88&text_color=ffffff&count_private=true" />
&nbsp;&nbsp;
<img height="160" src="https://github-readme-stats.vercel.app/api/top-langs/?username=suryaraj05&layout=compact&theme=chartreuse-dark&hide_border=true&bg_color=0a0a0a&title_color=00ff88&text_color=ffffff&langs_count=6&hide=html,css" />

</div>

<div align="center">

[![GitHub Streak](https://github-readme-streak-stats.herokuapp.com/?user=suryaraj05&theme=dark&hide_border=true&background=0a0a0a&ring=00ff88&fire=00ff88&currStreakLabel=00ff88)](https://github.com/suryaraj05)
